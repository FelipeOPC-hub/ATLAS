      ...
      <div className="mx-auto max-w-md px-5 sm:px-8">
        ...
        <form onSubmit={handleActivate} className="card mt-8 p-6 sm:p-8" noValidate>
          ...
          <input
            ...
            className={`mt-2 w-full rounded-xl border bg-white px-4 py-3.5 text-center font-mono text-lg font-bold tracking-widest text-slate-900 uppercase placeholder:text-slate-300 placeholder:tracking-widest placeholder:font-normal transition focus:outline-none focus:ring-4 ${
              state === 'error'
          ...
          {state === 'success' && (
            <div className="mt-3 flex items-center gap-2 rounded-lg bg-accent-50 px-4 py-2.5 text-sm text-accent-700">
            ...
            <div className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-slate-900">App ATLAS para Android</p>
                  <p className="text-sm text-slate-500">Descargá la app y empezá a operar.</p>
                </div>
              </div>
